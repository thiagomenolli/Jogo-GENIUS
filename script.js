...
let lightColor = (element, number) => {
    number = number * 500;
    setTimeout(() => {
        element.classList.add('selecter');
    }, number - 250);
    setTimeout(() => {
        element.classList.remove('selecter');
    });
}
...
let click = (color) => {
    ...
    createColorElement(color).classList.add('selecter');

    setTimeout(() => {
        createColorElement(color).classList.remove('selecter');
        checkOrder();
    },250);
}
